        ...
        stage('Setting up Environment') {
            ...
            stages{
                ...
                stage('E2E Tests on Browserstack') {
                    steps {
                        //dir('automation') {
                        checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '1564f87f-394c-454f-b4da-21b073f177d1', url: 'https://github.com/abrarmohammedfairsailcom/automate-java-samples']]])
                            script {
                                ...
                                if (isUnix()) {
                                    ...
                                    bat 'mvn clean compile exec:java'
                                }
                            }
                        //}
                    }
